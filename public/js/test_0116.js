...
async function init() {
  ...
  const provider = new Cesium.UrlTemplateImageryProvider({
    url: "https://stormscdn.ngs.noaa.gov/20250116m-maxar/{z}/{x}/{y}",
    tilingScheme: new Cesium.WebMercatorTilingScheme(),
    maximumLevel: 19,
    credit: "NOAA MAXAR 2025-01-16",
  });
  ...
  fireData.forEach((fire) => {
    if (fire.acq_date !== "2025-01-16") return;
  ...
  console.log(`✅ 2025-01-16 산불 ${count}개 표시 완료`);
