...
async function init() {
  ...
  const provider = new Cesium.UrlTemplateImageryProvider({
    url: "https://stormscdn.ngs.noaa.gov/20250110m-maxar/{z}/{x}/{y}",
    tilingScheme: new Cesium.WebMercatorTilingScheme(),
    maximumLevel: 19,
    credit: "NOAA MAXAR 2025-01-10",
  });
  ...
  fireData.forEach((fire) => {
    if (fire.acq_date !== "2025-01-10") return;
  ...
  console.log(`✅ 2025-01-10 산불 ${count}개 표시 완료`);
