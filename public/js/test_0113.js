...
async function init() {
  ...
  const provider = new Cesium.UrlTemplateImageryProvider({
    url: "https://stormscdn.ngs.noaa.gov/20250113m-maxar/{z}/{x}/{y}",
    tilingScheme: new Cesium.WebMercatorTilingScheme(),
    maximumLevel: 19,
    credit: "NOAA MAXAR 2025-01-13",
  });
  ...
  fireData.forEach((fire) => {
    if (fire.acq_date !== "2025-01-13") return;
  ...
  console.log(`✅ 2025-01-13 산불 ${count}개 표시 완료`);
